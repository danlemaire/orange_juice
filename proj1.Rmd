...
library(car)
glm(Purchase ~ . - MonthofPurchase, train, family = "binomial") %>% alias


glm(Purchase ~ PriceDiff + ListPriceDiff + SalePriceMM + SalePriceCH, train, family = "binomial")
glm(Purchase ~ SalePriceMM + SalePriceCH, train, family = "binomial")
